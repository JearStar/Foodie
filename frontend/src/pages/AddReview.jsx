...
function AddReview() {
    ...
    const isFormValid = () => {
        const allDishesValid = dishes.every(
            (dish) => dish.dishName !== '' && dish.score !== ''
        );
                ...
                <div className="col-12 col-md-6 col-lg-4">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                                ...
                                <div key={index} className="mb-3">
                                    <div className="d-flex justify-content-between">
                                        <select
                                            ...
                                            value={dish.dishName}
                                            onChange={(e) =>
                                                handleDishChange(index, 'dishName', e.target.value)
                                            }
                                            required
                                        >
                                            <option value="">Select Food Item</option>
                                            {
                                                dropdownDishes.map(dropdownDish => {
                                                    return (<option value={dropdownDish.dishName}>{dropdownDish.dishName}</option>)
                                                })
                                            }
                                        </select>
                                        <select
                                            ...
                                            value={dish.score}
                                            onChange={(e) =>
                                                handleDishChange(index, 'score', e.target.value)
                                            }
                                            required
                                        >
                                            <option value="">Score...</option>
                            ...
                            {dishError && (
                                <div className="alert alert-danger">{dishError}</div>
                            )}
                            <button
                                type="button"
                                ...
                                <div key={index} className="mb-3">
                                    <div className="d-flex flex-column">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                handlePhotoChange(index, 'imageURL', e.target.value)
                                            }
                                            required
                                        />
                                        <textarea
